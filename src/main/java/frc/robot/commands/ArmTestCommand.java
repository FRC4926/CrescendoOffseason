...
public class ArmTestCommand extends Command {
  ...
  if (Controllers.m_operatorController.getAButton()) {
      ...
      // {
        Subsystems.m_armSubsystem.goToSpecifiedAngleAmp(70);
      // } else 
      // {
    ...
    //   }
      ...
      if(Subsystems.m_limelightSubsystem.calcVerticalDistance()>114){
        Constants.Robot.SteadySpeedRPM = 3000;
      }else{
    ...
    Subsystems.m_armSubsystem.goToSpecifiedAngleAmp(-20);
    Constants.Robot.SteadySpeedRPM = 1350;
  }else{
      if(!Subsystems.m_armSubsystem.slackOver()){
