...
public class Robot extends TimedRobot {
  ...
  private Timer matchTime = new Timer();
  ...
  public void robotPeriodic() {
    SmartDashboard.putNumber("DistanceVoltage",Subsystems.m_shooterSubsystem.distanceSensor.getAverageVoltage());
    SmartDashboard.putBoolean("DistancePassed",Subsystems.m_shooterSubsystem.distanceSensorTriggered());
   ...
   // SmartDashboard.putNumber("AngleD", Subsystems.m_armSubsystem.armMotor.getEncoder().getPosition() * (180 / Math.PI));
    ...
    SmartDashboard.putNumber("VoltageOfFlashlight",Subsystems.m_shooterSubsystem.p.getCurrent(19));

    if (Subsystems.m_shooterSubsystem.getFlashBool())
    {
    ...
    if(Controllers.m_driverController.getYButtonReleased()){
      Subsystems.m_shooterSubsystem.setFlashBool();
    }
 ...
 // DigitalInput input = new DigitalInput(0);
  ...
  public void teleopPeriodic() {
    // if(matchTime.get()>=90){
    //   Controllers.m_driverController.setRumble(RumbleType.kBothRumble, 1);
    // }else{
