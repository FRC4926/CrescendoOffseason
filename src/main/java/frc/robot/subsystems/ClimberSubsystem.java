...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public boolean minEncoderMode = false;
  ...
  public void toggleEncoderMode() {
    minEncoderMode = !minEncoderMode;
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putBoolean("Min Encoder Mode", minEncoderMode);
  ...
  public void climb(double effort) {
    ...
    int minEncoderPosition = minEncoderMode ? 0 : -5;

    if (climber.getEncoder().getPosition() > minEncoderPosition && effort > 0) {
      climber.set(0);
