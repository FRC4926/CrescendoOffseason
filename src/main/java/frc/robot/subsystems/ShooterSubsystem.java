...
public class ShooterSubsystem extends SubsystemBase {
  public PowerDistribution p = new PowerDistribution(12, ModuleType.kRev);
  ...
  public AnalogInput distanceSensor = new AnalogInput(Constants.CAN_IDS.DISTANCE_ID);
 ...
 public double getTargetRPM(){
  ...
  public void setFlashBool(){
    flashBool = !flashBool;
  }

  public boolean getFlashBool(){
    return flashBool;
  }
  ...
  public boolean startStage(){
    return distanceSensor.getAverageVoltage()>.4; //original 0.45
  }
  ...
  public void updateHasPassed(){
    hasPassed = distanceSensorTriggered();
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Upper RPM", upperRPM());
